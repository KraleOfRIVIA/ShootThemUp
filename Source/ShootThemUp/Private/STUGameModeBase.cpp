...
void ASTUGameModeBase::CreateTeamsInfo()
{
	...
	for (auto It = GetWorld()->GetControllerIterator(); It; ++It)
	{
		...
		PlayerState->SetFLinearColor(DetermineColorByTeamID(TeamID));
...
void ASTUGameModeBase::SetPlayerColor(AController *Controller)
{
	...
	Character->SetPlayerColor(PlayerState->GetFLinearColor());
}
...
{
	const auto RespawnAvailabe = RoundCountDown > MinRoundTimeForRespawn + GameData.RespawnTime;
	if (!RespawnAvailabe)
		return;
...
{
	UE_LOG(LogSTUGameMode, Display, TEXT("Time its over"));
	LogPlayerInfo();
